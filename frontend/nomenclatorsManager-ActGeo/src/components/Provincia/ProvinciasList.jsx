...
import ProvinciaDataService from "../../services/ProvinciaService";
...
export default function ProvinciasList() { 
    ...
    const retrieveProvincias = () => {
    ProvinciaDataService.getAll()
      .then(response => {
     ...
     <div class="main">
       {<Header />}
        ...
        <div class="gp83">
            ...
            <Heading>Listado de Provincias</Heading>
          <section>
            {provincias.map((provincia,index) => (
              <Box key={provincia._id}
                bg="gray.100"
                p={4}
                m={4}
                borderRadius="lg"
              >
                <Flex align="center">
                  ...
                  <Text fontSize="2x1">
                      Provincia {index + 1} : <strong>{provincia.nombre}</strong>
                  </Text>
                </Flex>
              </Box>
            ))}  
