...
import EstadoDataService from "../../services/EstadoFactura";
...
export default function EstadosFacturasList() {
  ...
  return (
    <div class="main">
      ...
      <div class="gp83">
        ...
        >
          Listado de Estados de Facturas
        </Heading>
        <section>
          {estados.map((estado, index) => (
            <Box key={estado._id} bg="gray.100" p={4} m={4} borderRadius="lg">
              <Flex align="center">
                <img src={estadoLogo} width="32" height="32" />
                <Text fontSize="2x1">
                  Estado Factura {index + 1} : <strong>{estado.estado}</strong>
                </Text>
              </Flex>
            </Box>
          ))}
